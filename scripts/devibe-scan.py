...
Vendored from https://github.com/JCarterJohnson/vibecoded-design-tells
(skill/scripts/devibe_scan.py), MIT License, Copyright (c) 2026 Carter Johnson.
See THIRD_PARTY_LICENSES.md for the full license text. Used per DESIGN.md.
...
Usage:
    python3 scripts/devibe-scan.py <path>                 # scan a dir or file
    python3 scripts/devibe-scan.py <path> --severity high # only high-signal tells
    python3 scripts/devibe-scan.py <path> --json          # machine-readable (for CI)
    python3 scripts/devibe-scan.py <path> --max 8         # cap examples shown per rule
...
def main():
    ...
    print("  Layout and motion tells need eyes too. See DESIGN.md.\n")
    sys.exit(by_sev.get("high", 0))
