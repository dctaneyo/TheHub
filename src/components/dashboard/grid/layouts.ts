...
export const WIDGET_CATALOG: {
  ...
  { type: "leaderboard", title: "Leaderboard", defaultW: 4, defaultH: 6 },
...
export const PREDEFINED_LAYOUTS: GridLayout[] = [
  {
    ...
    widgets: [
      ...
      { id: "leaderboard", type: "leaderboard", title: "Leaderboard", w: 4, h: 6, position: { x: 0, y: 6 } },
      { id: "completed", type: "completed", title: "Completed & Missed", w: 4, h: 6, position: { x: 4, y: 6 } },
      { id: "messages", type: "messages", title: "Messages", w: 4, h: 3, position: { x: 8, y: 6 } },
      { id: "forms", type: "forms", title: "Forms", w: 4, h: 3, position: { x: 8, y: 9 } },
    ],
  },
  {
    id: "focus",
  ...
  },
  {
    ...
    widgets: [
      ...
      { id: "leaderboard", type: "leaderboard", title: "Leaderboard", w: 6, h: 6, position: { x: 6, y: 3 } },
      { id: "completed", type: "completed", title: "Completed & Missed", w: 6, h: 3, position: { x: 0, y: 9 } },
      { id: "calendar", type: "calendar", title: "Upcoming", w: 6, h: 3, position: { x: 6, y: 9 } },
    ],
  },
];
