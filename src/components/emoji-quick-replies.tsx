    ...
    <div className={`flex flex-wrap gap-2 ${className}`}>
      {EMOJI_QUICK_REPLIES.map((reply, index) => (
        <motion.button
          ...
          className="flex items-center gap-1 rounded-full bg-gradient-to-r from-slate-50 to-slate-100 border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-700 hover:from-orange-50 hover:to-red-50 hover:border-orange-200 hover:text-orange-700 transition-all shadow-sm hover:shadow"
        >
