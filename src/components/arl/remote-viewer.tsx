      ...
      <div className="flex h-12 shrink-0 items-center gap-3 border-b border-white/10 bg-neutral-900 px-4">
        ...
        {!isConnecting && !isEnded && (
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              onClick={onEnd}
              className="flex items-center gap-1 rounded-xl bg-red-500/20 px-3 py-2 text-xs font-semibold text-red-400 ring-1 ring-red-500/30 transition-colors active:bg-red-500/30"
            >
        ...
        {isConnecting && (
          <button
            onClick={onEnd}
            className="flex items-center gap-1 rounded-xl bg-white/10 px-3 py-2 text-xs font-semibold text-white/60 active:bg-white/15 transition-colors"
          >
            <X className="h-3.5 w-3.5" />
            Cancel
          </button>
